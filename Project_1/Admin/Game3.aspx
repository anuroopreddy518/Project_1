<%@ Page Title="Game3" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Game3.aspx.cs" Inherits="Project_1.Admin.Game3" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <h1>Game 3 Details</h1>

                <asp:PlaceHolder ID="GamePlaceHolder" runat="server">               
                    <a href="/Details/Game3_Details.aspx" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>Add Game</a>
                </asp:PlaceHolder>
